    ...
    return InkWell(
        onTap: () {
          Navigator.of(context).push(SlideRightRoute(
              page: ClassDetail(
                  classId, className, section, subject, isInstructor)));
        },
        child: buildClass(context, mq.height * 0.16, mq.width, classId,
            className, section, isInstructor));
  }
}

Widget buildClass(BuildContext context, double height, double width,
    String classId, String className, String section, bool isInstructor) {
  return Card(
    elevation: 5,
          ...
          child: Container(
            ...
            child: isInstructor == true
                ? Image.asset("assets/images/instructor.jpeg",
                    fit: BoxFit.cover)
                : Image.asset("assets/images/joined.jpeg", fit: BoxFit.cover),
          ),
        ),
        Container(
